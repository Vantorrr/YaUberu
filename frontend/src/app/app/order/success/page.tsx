...
export default function SuccessPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-5 py-10">
      ...
      {/* Title */}
      <h1 className="text-2xl font-bold text-gray-900 mb-2 text-center">Заказ оформлен!</h1>
      ...
      {/* Reminder */}
      <div className="w-full max-w-sm bg-orange-50 border border-orange-200 rounded-2xl p-4 mb-8 flex items-start gap-3">
