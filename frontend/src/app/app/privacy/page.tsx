    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="px-5 py-6 space-y-6 pb-24">
        ...
        <div className="space-y-6 text-gray-700">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">2. Собираемая информация</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">3. Цели сбора информации</h2>
            <p className="text-sm leading-relaxed mb-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">8. Изменения в политике</h2>
            <p className="text-sm leading-relaxed">
